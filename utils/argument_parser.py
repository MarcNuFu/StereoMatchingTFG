...
def get_arguments():
    ...
    ap.add_argument('--maxdisp',            type=int,   default=192,                                    help='Maximum disparity. Default is 192')
    ap.add_argument('--checkloss',          type=float, default=1,                                      help='Min loss to start saving checkpoints. Default is 1')
    ...
    ap.add_argument('--milestones',                     default=[300,500,900,1100,1500,1700,2100,2300], help='Epochs at which learning rate is divided by 10')  
    args = ap.parse_args()
...
def print_arguments(args):
    ...
    print('--checkloss          : ', args.checkloss)
